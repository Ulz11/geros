...
const I18N = {
  en: {
    ...
    prices: "Price list", priceList: "Price list", priceService: "Service", priceUnit: "Unit", addService: "Add service",
    editService: "Edit service", per_person: "per person", per_night: "per night",
    per_person_night: "per person / night", fixed: "fixed",
    meal: "Meal", accommodation: "Accommodation", guide: "Guide", activity: "Activity",
    transport: "Transport", other_cat: "Other",
    guests: "Guests", addGuest: "Register guest", editGuest: "Edit guest",
    passportNo: "Passport №", linkedBooking: "Booking", search: "Search…",
    fromPriceList: "Add from price list", folder: "Folder", newFolder: "New folder…",
    documents: "Documents", inactive_s: "inactive",
  },
  mn: {
    ...
    prices: "Үнийн жагсаалт", priceList: "Үнийн жагсаалт", priceService: "Үйлчилгээ", priceUnit: "Нэгж", addService: "Үйлчилгээ нэмэх",
    editService: "Үйлчилгээ засах", per_person: "хүн тутамд", per_night: "хоног тутамд",
    per_person_night: "хүн / хоног", fixed: "тогтмол",
    meal: "Хоол", accommodation: "Байр", guide: "Хөтөч", activity: "Аялал",
    transport: "Тээвэр", other_cat: "Бусад",
    guests: "Зочид", addGuest: "Зочин бүртгэх", editGuest: "Зочин засах",
    passportNo: "Паспортын №", linkedBooking: "Захиалга", search: "Хайх…",
    fromPriceList: "Үнийн жагсаалтаас нэмэх", folder: "Хавтас", newFolder: "Шинэ хавтас…",
    documents: "Баримт бичиг", inactive_s: "идэвхгүй",
  },
};
